...
export const demoHomeState: HomeState = {
  ...
  rooms: [
    ...
    },
    {
      ...
      bbox: { x: 0.53, y: 0.49, width: 0.09, height: 0.12 },
      sort_order: 8,
  ...
  routines: [
    {
      ...
      description: "3 veces por dia · 30 minutos",
      status: "active",
      cadence: "3x/dia 30m",
    ...
    },
    {
      ...
      description: "40 minutos manana y noche",
      status: "active",
      cadence: "2x/dia 40m",
      next_run_at: undefined,
      last_run_at: undefined,
    ...
    },
    {
      ...
      description: "Encender de noche, apagar de dia",
      status: "active",
      cadence: "Nocturno",
    ...
    },
    {
      ...
      home_id: "demo-home",
      name: "Persianas",
      description: "Abiertas de dia · cerradas de noche",
      status: "paused",
      cadence: "Diario",
    ...
    },
    {
      ...
      description: "Apagados dia · encender 16:30",
      status: "active",
